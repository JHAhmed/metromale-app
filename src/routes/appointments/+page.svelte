		...
		{:then appointmentsData}
			...
			{#if appointmentsData.total === 0}
				<div class="py-12 text-center">
					...
					<a
						...
						class="inline-flex items-center rounded-full bg-red-400 px-6 py-3 text-sm font-semibold text-white active:scale-99 active:bg-red-500">
			...
			{:else}
				<div class="mb-6 flex items-center justify-between">
					...
					<a
						href="/appointments/new"
						class="group flex items-center gap-2 rounded-full bg-red-400 px-4 py-2 text-sm font-medium text-white transition-all focus:outline-none active:scale-[98%] active:bg-red-500">
				...
				{#if next}
					<div class="mb-10">
						...
						<div
							class="relative overflow-hidden rounded-3xl bg-white/80 p-6 shadow-lg/1 backdrop-blur-md">
							...
							<a
								...
								class="mt-6 block w-full cursor-pointer rounded-xl bg-primary py-2.5 text-center text-sm font-medium text-white transition-all hover:bg-primary/80 hover:shadow-sm">
								View Details
							</a>
						</div>
					</div>
